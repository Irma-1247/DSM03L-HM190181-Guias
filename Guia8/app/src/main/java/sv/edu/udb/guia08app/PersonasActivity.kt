    ...
    private fun inicializar() {
        ...
        listaPersonas!!.setOnItemClickListener(object : AdapterView.OnItemClickListener {
            override fun onItemClick(adapterView: AdapterView<*>?, view: View, i: Int, l: Long) {
                ...
                intent.putExtra("fecha", personas!![i].fecha)
                intent.putExtra("genero", personas!![i].genero)
                intent.putExtra("peso", personas!![i].peso)
                intent.putExtra("altura", personas!![i].altura)
