...
class RegisterActivity : AppCompatActivity() {
    ...
    //Referencia a componentes del layaout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Inicializamos el objeto FireabaseAuth
        ...
        //Verificando si existe un usuario activo
        this.checkUser()
    }
    ...
    //Verificando si existe una sesión previa
